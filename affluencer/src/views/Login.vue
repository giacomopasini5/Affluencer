  ...
  <div id="login">
    ...
    <form @submit.prevent="handleSubmit" novalidate>
      <div class="form-item">
        ...
        <router-link to="/registerClient" class="form-button">Registrati - Cliente</router-link>
				<router-link to="/registerStore" class="form-button">Registrati - Negozio</router-link>
      </div>
		</form>
  </div>
</template>
